  ...
  return (
    <div className="container-lg">
      <div className="d-flex justify-content-start flex-wrap align-items-center mb-0 tabs">
        ...
        >
          <span className="mx-2">{t("latest_news.mainTitle")}</span>
        </NavLink>
        ...
        <NavLink
          ...
          className="tablinks border-0 m-2 mb-0  p-2 pb-0"
        >
          <span className="mx-2">{t("disclosures.mainTitle")}</span>
        </NavLink>
        ...
        <NavLink
          ...
          className="tablinks border-0 m-2 mb-0  p-2 pb-0 "
        >
          <span className="mx-2">{t("earnings.title")}</span>
        </NavLink>
        ...
        <NavLink
          ...
          className="tablinks border-0 m-2 mb-0  p-2 pb-0 "
        >
          <span className="mx-2">{t("events.mainTitle")}</span>
        </NavLink>
      </div>
      <Outlet />
    </div>
